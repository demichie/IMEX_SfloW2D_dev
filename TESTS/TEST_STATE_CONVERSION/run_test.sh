...
gfortran -O0 -g -fopenmp -fcheck=all -fbacktrace \
    -c \
...
gfortran -O0 -g -fopenmp -fcheck=all -fbacktrace \
    ...
    complexify.o geometry_2d.o state_conversion_2d.o \
    equation_terms_2d.o constitutive_2d.o test_state_conversion.o -llapack \
