...
build_dir=$(mktemp -d /tmp/imex-stochastic-evolution.XXXXXX)
...
gfortran -O0 -g -Wall -Wextra -fopenmp -fcheck=all -fbacktrace -c \
    ...
    "$repo_dir/src/stochastic_module.f90" \
    "$test_dir/test_stochastic_evolution.f90"

gfortran -O0 -g -Wall -Wextra -fopenmp -fcheck=all -fbacktrace \
    parameters_2d.o diagnostics_2d.o stochastic_random_2d.o \
    constitutive_parameters_2d.o model_layout_2d.o \
    equation_metadata_2d.o complexify.o \
    geometry_2d.o state_conversion_2d.o equation_terms_2d.o \
    constitutive_2d.o state_2d.o domain_2d.o stochastic_module.o \
    test_stochastic_evolution.o -llapack -o test_stochastic_evolution
