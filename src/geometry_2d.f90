...
CONTAINS
   ...
   SUBROUTINE topography_zones
      ...
      y_loop:DO j = 1,comp_cells_x

         x_loop:DO k = 1,comp_cells_y
      ...
      y_loop2:DO j = 1,comp_cells_x

         x_loop2:DO k = 1,comp_cells_y
      ...
      y_loop3:DO j = 1,comp_cells_x

         x_loop3:DO k = 1,comp_cells_y
   ...
   SUBROUTINE topography_reconstruction
      ...
      ! Left boundary (j=1,2)
      B_prime_x_geom(1:2,:)   = SPREAD(B_prime_x_geom(3,:), 1, 2)
      B_prime_y_geom(1:2,:)   = SPREAD(B_prime_y_geom(3,:), 1, 2)
      B_second_xx_geom(1:2,:) = SPREAD(B_second_xx_geom(3,:), 1, 2)
      B_second_yy_geom(1:2,:) = SPREAD(B_second_yy_geom(3,:), 1, 2)
      B_second_xy_geom(1:2,:) = SPREAD(B_second_xy_geom(3,:), 1, 2)

      ! Right boundary (j=comp_cells_x-1, comp_cells_x)
      B_prime_x_geom(comp_cells_x-1:comp_cells_x,:) = SPREAD(B_prime_x_geom(comp_cells_x-2,:), 1, 2)
      B_prime_y_geom(comp_cells_x-1:comp_cells_x,:) = SPREAD(B_prime_y_geom(comp_cells_x-2,:), 1, 2)
      B_second_xx_geom(comp_cells_x-1:comp_cells_x,:) = SPREAD(B_second_xx_geom(comp_cells_x-2,:), 1, 2)
      B_second_yy_geom(comp_cells_x-1:comp_cells_x,:) = SPREAD(B_second_yy_geom(comp_cells_x-2,:), 1, 2)
      B_second_xy_geom(comp_cells_x-1:comp_cells_x,:) = SPREAD(B_second_xy_geom(comp_cells_x-2,:), 1, 2)

      ! --- Handle top and bottom boundaries (rows k=1, 2, comp_cells_y-1, comp_cells_y) ---
      ! Top boundary (k=1,2)
      B_prime_x_geom(:,1:2)   = SPREAD(B_prime_x_geom(:,3), 2, 2)
      B_prime_y_geom(:,1:2)   = SPREAD(B_prime_y_geom(:,3), 2, 2)
      B_second_xx_geom(:,1:2) = SPREAD(B_second_xx_geom(:,3), 2, 2)
      B_second_yy_geom(:,1:2) = SPREAD(B_second_yy_geom(:,3), 2, 2)
      B_second_xy_geom(:,1:2) = SPREAD(B_second_xy_geom(:,3), 2, 2)

      ! Bottom boundary (k=comp_cells_y-1, comp_cells_y)
      B_prime_x_geom(:,comp_cells_y-1:comp_cells_y) = SPREAD(B_prime_x_geom(:,comp_cells_y-2), 2, 2)
      B_prime_y_geom(:,comp_cells_y-1:comp_cells_y) = SPREAD(B_prime_y_geom(:,comp_cells_y-2), 2, 2)
      B_second_xx_geom(:,comp_cells_y-1:comp_cells_y) = SPREAD(B_second_xx_geom(:,comp_cells_y-2), 2, 2)
      B_second_yy_geom(:,comp_cells_y-1:comp_cells_y) = SPREAD(B_second_yy_geom(:,comp_cells_y-2), 2, 2)
      B_second_xy_geom(:,comp_cells_y-1:comp_cells_y) = SPREAD(B_second_xy_geom(:,comp_cells_y-2), 2, 2)
